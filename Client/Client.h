...
class ClientLoadingScreen : public wi::LoadingScreen
{
private:
	wi::Sprite sprite;
	wi::SpriteFont font;
...
class Client;
class ClientComponent : public wi::RenderPath2D
{
private:
...
class Client : public wi::Application
{
public:
	ClientComponent renderComponent;
	ClientLoadingScreen loader;
