...
namespace wi::lua
{
	...
	void Input_BindLua::Bind(lua_State* L)
	{
		...
		if (!initialized)
		{
			...
			wi::lua::RunText(wi::lua::GetLuaState(), "MOUSE_BUTTON_RIGHT			= 2");
			wi::lua::RunText(wi::lua::GetLuaState(), "MOUSE_BUTTON_MIDDLE		= 3");

			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_UP			= 4");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_DOWN		= 5");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_LEFT		= 6");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_RIGHT		= 7");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_SPACE		= 8");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_RSHIFT		= 9");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_LSHIFT		= 10");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F1			= 11");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F2			= 12");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F3			= 13");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F4			= 14");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F5			= 15");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F6			= 16");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F7			= 17");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F8			= 18");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F9			= 19");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F10		= 20");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F11		= 21");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_F12		= 22");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_ENTER		= 23");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_ESCAPE		= 24");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_HOME		= 25");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_RCONTROL	= 26");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_LCONTROL	= 27");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_DELETE		= 28");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_BACK		= 29");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_PAGEDOWN	= 30");
			wi::lua::RunText(wi::lua::GetLuaState(), "KEYBOARD_BUTTON_PAGEUP		= 31");

			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_UP			= 257");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_LEFT		= 258");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_DOWN		= 259");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_RIGHT		= 260");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_1			= 261");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_2			= 262");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_3			= 263");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_4			= 264");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_5			= 265");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_6			= 266");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_7			= 267");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_8			= 268");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_9			= 269");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_10			= 270");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_11			= 271");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_12			= 272");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_13			= 273");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_BUTTON_14			= 274");

			//Analog
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_ANALOG_THUMBSTICK_L	= 0");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_ANALOG_THUMBSTICK_R	= 1");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_ANALOG_TRIGGER_L		= 2");
			wi::lua::RunText(wi::lua::GetLuaState(), "GAMEPAD_ANALOG_TRIGGER_R		= 3");

			//Touch
			wi::lua::RunText(wi::lua::GetLuaState(), "TOUCHSTATE_PRESSED		= 0");
			wi::lua::RunText(wi::lua::GetLuaState(), "TOUCHSTATE_RELEASED	= 1");
