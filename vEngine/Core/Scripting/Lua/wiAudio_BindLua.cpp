...
namespace wi::lua
{
	...
	void Audio_BindLua::Bind(lua_State* L)
	{
		...
		if (!initialized)
		{
			...
			/*
            wi::lua::RunText(L, "vEngine." + std::to_string(Audio_BindLua::className) + " = " + "vEngine." + std::to_string(Audio_BindLua::className)  + "()");
			wi::lua::RunText(L, "SUBMIX_TYPE_SOUNDEFFECT = 0");
			wi::lua::RunText(L, "SUBMIX_TYPE_MUSIC = 1");
			wi::lua::RunText(L, "SUBMIX_TYPE_USER0 = 2");
			wi::lua::RunText(L, "SUBMIX_TYPE_USER1 = 3");

			wi::lua::RunText(L, "REVERB_PRESET_DEFAULT = 0");
			wi::lua::RunText(L, "REVERB_PRESET_GENERIC = 1");
			wi::lua::RunText(L, "REVERB_PRESET_FOREST = 2");
			wi::lua::RunText(L, "REVERB_PRESET_PADDEDCELL = 3");
			wi::lua::RunText(L, "REVERB_PRESET_ROOM = 4");
			wi::lua::RunText(L, "REVERB_PRESET_BATHROOM = 5");
			wi::lua::RunText(L, "REVERB_PRESET_LIVINGROOM = 6");
			wi::lua::RunText(L, "REVERB_PRESET_STONEROOM = 7");
			wi::lua::RunText(L, "REVERB_PRESET_AUDITORIUM = 8");
			wi::lua::RunText(L, "REVERB_PRESET_CONCERTHALL = 9");
			wi::lua::RunText(L, "REVERB_PRESET_CAVE = 10");
			wi::lua::RunText(L, "REVERB_PRESET_ARENA = 11");
			wi::lua::RunText(L, "REVERB_PRESET_HANGAR = 12");
			wi::lua::RunText(L, "REVERB_PRESET_CARPETEDHALLWAY = 13");
			wi::lua::RunText(L, "REVERB_PRESET_HALLWAY = 14");
			wi::lua::RunText(L, "REVERB_PRESET_STONECORRIDOR = 15");
			wi::lua::RunText(L, "REVERB_PRESET_ALLEY = 16");
			wi::lua::RunText(L, "REVERB_PRESET_CITY = 17");
			wi::lua::RunText(L, "REVERB_PRESET_MOUNTAINS = 18");
			wi::lua::RunText(L, "REVERB_PRESET_QUARRY = 19");
			wi::lua::RunText(L, "REVERB_PRESET_PLAIN = 20");
			wi::lua::RunText(L, "REVERB_PRESET_PARKINGLOT = 21");
			wi::lua::RunText(L, "REVERB_PRESET_SEWERPIPE = 22");
			wi::lua::RunText(L, "REVERB_PRESET_UNDERWATER = 23");
			wi::lua::RunText(L, "REVERB_PRESET_SMALLROOM = 24");
			wi::lua::RunText(L, "REVERB_PRESET_MEDIUMROOM = 25");
			wi::lua::RunText(L, "REVERB_PRESET_LARGEROOM = 26");
			wi::lua::RunText(L, "REVERB_PRESET_MEDIUMHALL = 27");
			wi::lua::RunText(L, "REVERB_PRESET_LARGEHALL = 28");
			wi::lua::RunText(L, "REVERB_PRESET_PLATE = 29");
            */
